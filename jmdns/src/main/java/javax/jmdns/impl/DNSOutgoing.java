...
public final class DNSOutgoing extends DNSMessage {
    ...
    /**
     * This can be used to turn off domain name compression. This was helpful for tracking problems interacting with other mdns
     * implementations.
     */
     ...
     *        The sender's UDP payload size is the number of bytes of the largest UDP payload that can be reassembled and
     ...
     *
     * @param destination
     *        Set a destination address a packet should be sent to (instead the default one). You could use null to unset the
     *        forced destination.
     */
    ...
    public int availableSpace() {
        return _maxUDPPayload - HEADER_SIZE - _questionsBytes.size() - _answersBytes.size() - _authoritativeAnswersBytes.size()
