...
/**
 * This class is used by JmDNS to start the various task required to run the DNS discovery. This interface is only there in
 * order to support MANET modifications.
 * <p>
...
public interface DNSTaskStarter {
    ...
    public static final class DNSTaskStarterImpl implements DNSTaskStarter {
        ...
        /**
         * The timer is used to dispatch all outgoing messages of JmDNS. It is also used to dispatch maintenance tasks for the
         * DNS cache.
         */
