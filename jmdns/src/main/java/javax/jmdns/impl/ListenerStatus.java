...
public class ListenerStatus<T extends EventListener> {
    ...
    public static class ServiceListenerStatus extends ListenerStatus<ServiceListener> {
         ...
         * <b>Note:</b>This event is only the service added event. The service info associated with this event does not include
         * resolution information.<br/>
         * To get the full resolved information you need to listen to {@link #serviceResolved(ServiceEvent)} or call
        ...
        private static final boolean _sameInfo(ServiceInfo info, ServiceInfo lastInfo) {
            ...
            if (!info.hasSameAddresses(lastInfo))
                return false;
