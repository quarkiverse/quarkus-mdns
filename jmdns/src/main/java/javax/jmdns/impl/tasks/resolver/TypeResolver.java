...
public class TypeResolver extends DNSResolverTask {
    ...
    protected DNSOutgoing addAnswers(final DNSOutgoing out) throws IOException {
        ...
        for (final ServiceTypeEntry typeEntry : this.getDns().getServiceTypes().values()) {
            newOut = this.addAnswer(newOut, new DNSRecord.Pointer("_services._dns-sd._udp.local.", DNSRecordClass.CLASS_IN,
    ...
    protected DNSOutgoing addQuestions(DNSOutgoing out) throws IOException {
        return this.addQuestion(out, DNSQuestion.newQuestion("_services._dns-sd._udp.local.", DNSRecordType.TYPE_PTR,
