...
public interface DNSStatefulObject {
    ...
    /**
     * This class define a semaphore. On this multiple threads can wait the arrival of one event. Thread wait for a maximum
     * defined by the timeout.
     * <p>
     * Implementation note: this class is based on {@link java.util.concurrent.Semaphore} so that they can be released by the
     * timeout timer.
     * </p>
     *
     * @author Pierre Frisch
    ...
    public static class DefaultImplementation extends ReentrantLock implements DNSStatefulObject {
        ...
        public String toString() {
            try {
                return (_dns != null ? "DNS: " + _dns.getName() + " [" + _dns.getInetAddress() + "]" : "NO DNS") + " state: "
                        + _state + " task: " + _task;
