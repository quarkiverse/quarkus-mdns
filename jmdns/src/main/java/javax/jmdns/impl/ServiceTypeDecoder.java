...
class ServiceTypeDecoder {
    ...
    private static final Pattern SUBTYPE_PATTERN = Pattern
            .compile("^((.*)\\._)?_?(.*)\\._sub\\._([^.]*)\\._([^.]*)\\.(.*)\\.?$", Pattern.CASE_INSENSITIVE);
    ...
    static Map<Fields, String> decodeQualifiedNameMapForType(String type) {
        ...
        return ServiceInfoImpl.createQualifiedMap(name, ServiceInfoImpl.removeSeparators(application), protocol,
                ServiceInfoImpl.removeSeparators(domain), subtype);
    }
