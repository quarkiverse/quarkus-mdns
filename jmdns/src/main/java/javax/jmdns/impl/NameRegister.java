...
public interface NameRegister {
    ...
    public static class UniqueNamePerInterface extends BaseRegister {
         ...
         * (non-Javadoc)
         *
         * @see javax.jmdns.impl.NameRegister#register(java.net.InetAddress, java.lang.String,
         ...
         * (non-Javadoc)
         *
         * @see javax.jmdns.impl.NameRegister#checkName(java.net.InetAddress, java.lang.String,
         * javax.jmdns.impl.NameRegister.NameType)
         */
        @Override
         ...
         * (non-Javadoc)
         *
         * @see javax.jmdns.impl.NameRegister#incrementHostName(java.net.InetAddress, java.lang.String,
         * javax.jmdns.impl.NameRegister.NameType)
         */
        @Override
