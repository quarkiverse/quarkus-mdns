 ...
 *
 * <ol>
 * <li>&lt;servicedomain&gt;.&lt;parentdomain&gt;: This is the domain scope of the service typically "local.", but this can also
 * be something similar to "in-addr.arpa." or "ip6.arpa."</li>
...
public abstract class ServiceInfo implements Cloneable {
     ...
     * @return new service info
     */
    public static ServiceInfo create(final String type, final String name, final String subtype, final int port,
            final String text) {
     ...
     * @return new service info
     */
    public static ServiceInfo create(final String type, final String name, final int port, final int weight, final int priority,
            final String text) {
    ...
    /**
     * Construct a service description for registering with JmDNS. The properties hashtable must map property names to either
     * Strings or byte arrays describing the property values.
     *
     * @param type
     *        fully qualified service type name, such as <code>_http._tcp.local.</code>.
     * @param name
     ...
     *        dictionary of values to build the fully qualified service name. Mandatory keys are Application and Instance. The
     *        Domain default is local, the Protocol default is tcp and the subtype default is none.
     * @param port
     *        the local port on which the service runs
     * @param weight
     *        weight of the service
     ...
     * @return new service info
     */
    public static ServiceInfo create(final Map<Fields, String> qualifiedNameMap, final int port, final int weight,
            final int priority, final boolean persistent, final Map<String, ?> props) {
    ...
    /**
     * Get the text for the service. This will interpret the text bytes as a UTF8 encoded string. Will return null if the bytes
     * are not a valid UTF8 encoded string.<br/>
     * <b>Note:</b> Do not use. This method make the assumption that the TXT record is one string. This is false. The TXT record
     * is a series of key value pairs.
     *
     * @return service text
    ...
    /**
     * Get a property of the service. This involves decoding the text bytes into a property list. Returns null if the property
    ...
    /**
     * Get a property of the service. This involves decoding the text bytes into a property list. Returns null if the property
     * is not found, the text data could not be decoded correctly, or the resulting bytes are not a valid UTF8 string.
     *
     * @param name
     *        property name
