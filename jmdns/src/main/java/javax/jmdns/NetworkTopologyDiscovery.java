 ...
 * <p>
 * To create you own filtering class for Internet Addresses you will need to implement the class and the factory delegate. These
 * must be called before any other call to JmDNS.
 *
 * <pre>
