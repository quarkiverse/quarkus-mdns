...
public abstract class JmDNS implements Closeable {
     ...
     * Check that your platform correctly handle the default localhost IP address and the local hostname. In doubt use the
     ...
     * Create an instance of JmDNS and bind it to a specific network interface given its IP-address.
     * </p>
     * If <code>addr</code> parameter is null this method will try to resolve to a local IP address of the machine using a
     * network discovery:
     * <ol>
     ...
     * </ol>
     * <p>
     * <b>Note:</b> If you need to use a custom {@link NetworkTopologyDiscovery} it must be setup before any call to this
     * method. This is done by setting up a {@link NetworkTopologyDiscovery.Factory.ClassDelegate} and installing it using
     * {@link NetworkTopologyDiscovery.Factory#setClassDelegate(NetworkTopologyDiscovery.Factory.ClassDelegate)}. This must be
     * done before creating a {@link JmDNS} or {@link JmmDNS} instance.
     * </p>
     *
     * @param addr
     *        IP address to bind to.
    ...
    /**
     * Return the HostName associated with this JmDNS instance. Note: May not be the same as what started. The host name is
    ...
    /**
     * Get service information. If the information is not cached, the method will block for the given timeout until updated
     * information is received.
     * <p/>
     * Usage note: If you call this method from the AWT event dispatcher thread, use a small timeout, or you will make the user
    ...
    /**
     * Request service information. The information about the service is requested and the ServiceListener.resolveService method
     * is called as soon as it is available.
     * <p/>
     * Usage note: Do not call this method from the AWT event dispatcher thread. You will make the user interface unresponsive.
     *
     * @param type
    ...
    /**
     * Register a service. The service is registered for access by other jmdns clients. The name of the service may be changed
     * to make it unique.<br>
     * Note that the given {@code ServiceInfo} is bound to this {@code JmDNS} instance, and should not be reused for any other
     ...
     * <p>
     * <b>Note:</b> Unregistered services will not disappear form the list of services immediately. According to the
     * specification, when unregistering services we send goodbye packets and then wait <b>1s</b> before purging the cache.<br/>
    ...
    /**
     * Register a service type. If this service type was not already known, all service listeners will be notified of the new
     * service type.
     * <p>
    ...
    /**
     * Returns a list of service infos of the specified type sorted by subtype. Any service that do not register a subtype is
     * listed in the empty subtype section.
     *
     * @param type
     *        Service type name, such as <code>_http._tcp.local.</code>.
